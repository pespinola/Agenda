...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (daocontacto.getAllStudentsList().size() == 0) {
            daocontacto.addContactoDetail(new Contacto("Patricia Espínola", "5532107785", "pespinola@gmail.com"));
            daocontacto.addContactoDetail(new Contacto("Julio Vega", "958562458", "jvega@gmail.com"));
            daocontacto.addContactoDetail(new Contacto("Carlos Dominguez", "986215478", "cdominguez@gmail.com"));
        }
